...
public class Construcao implements CarbonFootprint{
    ...
    public Construcao(boolean energiaRenovavel, int qtdLamp, int qtdArCondicionado){
    ...
    public Construcao(boolean energiaRenovavel, int qtdLamp, int qtdArCondicionado, String combustivelAquecimento){
        this.energiaRenovavel = energiaRenovavel;
        this.qtdLamp = qtdLamp;
        this.qtdArCondicionado = qtdArCondicionado;
    ...
    /*  
    0,000066 toneladas de CO2 por kWh
    0,0002 toneladas de CO2 por kWh de gás natural
    0,0002 toneladas de CO2 por kWh de óleo de aquecimento
    0,0003 toneladas de CO2 por kWh de carvão
    0,0002 toneladas de CO2 por kWh de GLP
    0,00015 toneladas de CO2 por kWh de propano
    */
}

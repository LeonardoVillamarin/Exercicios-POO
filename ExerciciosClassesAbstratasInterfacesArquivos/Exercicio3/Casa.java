...
public class Casa extends Edificio{
    ...
    public Casa(boolean energiaRenovavel, int qtdLamp, int qtdArCondicionado){
        super(energiaRenovavel, qtdLamp, qtdArCondicionado);
    }
    public Casa(boolean energiaRenovavel, int qtdLamp, int qtdArCondicionado, String combustivelAquecimento){
